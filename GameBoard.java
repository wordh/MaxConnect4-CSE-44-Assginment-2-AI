...
public class GameBoard {
	...
	/**
	 * this method returns the score for the player given as an argument. it
	 * checks horizontally, vertically, and each direction diagonally.
	 * currently, it uses for loops, but i'm sure that it can be made more
	 * efficient.
	 * 
	 * @param player
	 *            the player whose score is being requested. valid values are 1
	 *            or 2
	 ...
	 * 
	 * @return an integer value representing whose turn it is. either a 1 or a 2
	 */
	 ...
	 * board
	 * 
	 * @return an integer representing the number of pieces that have been
	 *         played on board already
	 */
	 ...
	 * 
	 * @param column
	 *            an int representing the column to be played in.
	 ...
	 * 
	 * @param column
	 *            the column where the piece is to be played.
	 ...
	 * 
	 * @param outputFile
	 *            the path and file name of the file to be written
	 */
	...
	public void setNext_chance(String next_chance) {
		...
		if (this.next_chance.equalsIgnoreCase("computer-next")) {
